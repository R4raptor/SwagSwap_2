    ...
    <div className="flex gap-5 ">
      ...
      <div className="flex flex-col gap-5 w-full">
        <div className="flex gap-5 items-center">
          ...
          <Input
            type="text"
            placeholder="🔍 Search Products here ...                            Happy SwagSwaping 😉"
            ...
            return (
              ...
              >
                <img
                  ...
                  className="w-full h-52 p-2 rounded-md object object-cover"
                  alt=""
                />
                <div className="px-2 flex flex-col">
                  ...
                  <p className="text-sm">
                    ...
                    {product.age===1 ?"year":"years"} {' '}
                      old</p>
                  <Divider />
                  <span className="text-xl font font-semibold text-green-600">
                    Rs. {product.price}
                  </span>
                </div>
              </div>
